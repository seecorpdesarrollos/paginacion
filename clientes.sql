...
-- Volcando datos para la tabla clientes.cliente: ~200 rows (aproximadamente)
/*!40000 ALTER TABLE `cliente` DISABLE KEYS */;
REPLACE INTO `cliente` (`id`, `nombre`, `activo`, `correo`, `zip`, `telefono1`, `telefono2`, `pais`, `direccion`) VALUES
